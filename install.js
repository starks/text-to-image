...
var XpiInstaller = {
   ...
   extFullName    : 'Text-to-Image', // The name displayed to the user (don't include the version)
   extShortName   : 'txttoimage', // The leafname of the JAR file (without the .jar part)
   extVersion     : '1.3.0.5',
   extAuthor      : 'Starks and Toad King',
   extLocaleNames : ['ca-AD','cs-CZ','da-DK','de-DE','en-US','es-AR','es-ES','fr-FR','hr-HR','it-IT','pt-BR','ro-RO','zh-TW'], // e.g., ['en-US', 'en-GB']
   extSkinNames   : ['classic'], // e.g., ['classic', 'modern']
   extPreferences : 'txttoimage.js', // e.g., ['extension.js']
